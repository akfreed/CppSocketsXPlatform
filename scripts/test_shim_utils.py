...
def test_filter_files_by_ext():
    result = filter_files_by_ext(  ".h", ["pocc-shim.py", R"alice/bob.h", R"bob.h/blah", R"alice\windows\bob.hpp", R"alice\windows\bob.h"])
    assert result ==                     ["pocc-shim.py", R"bob.h/blah", R"alice\windows\bob.hpp"]

    result = filter_files_by_ext(".cpp", ["pocc-shim.py", R"alice/bob.h", R"bob.h/blah", R"alice\windows\bob.hpp", R"alice\windows\bob.h", R"alice/windows\bob.cpp"])
    assert result ==                     ["pocc-shim.py", R"alice/bob.h", R"bob.h/blah", R"alice\windows\bob.hpp", R"alice\windows\bob.h"]

    result = filter_files_by_ext(   ".", ["pocc-shim.py", R"alice/bob.h", R"bob.h/blah", R"alice\windows\bob.hpp", R"alice\windows\bob.h"])
    assert result ==                     ["pocc-shim.py", R"alice/bob.h", R"bob.h/blah", R"alice\windows\bob.hpp", R"alice\windows\bob.h"]

    result = filter_files_by_ext(    "", ["pocc-shim.py", R"alice/bob.h", R"bob.h\blah.", R"alice/windows/bob.hpp", R"alice\windows\bob.h"])
    assert result ==                     ["pocc-shim.py", R"alice/bob.h", R"alice/windows/bob.hpp", R"alice\windows\bob.h"]
